        ...
        <div className="container-custom max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-heading font-bold text-xl text-navy mb-2">Warm & Friendly</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-heading font-bold text-xl text-navy mb-2">Trust Signals</h3>
              <p className="text-slate">
            ...
            <div className="text-center">
              ...
              <h3 className="font-heading font-bold text-xl text-navy mb-2">Easy Booking</h3>
              <p className="text-slate">
