      ...
      <section className="section-padding">
        <div className="container-custom max-w-5xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <Link href="/trades-websites" className="bg-white rounded-xl p-6 shadow-md border border-gray-100 hover:shadow-lg hover:border-lime/50 transition-all group">
              <div className="flex items-center gap-3 mb-2 sm:block">
                ...
                <h3 className="font-heading font-bold text-lg text-navy sm:mb-2 group-hover:text-lime transition-colors">Trades</h3>
              </div>
            ...
            <Link href="/pet-care-websites" className="bg-white rounded-xl p-6 shadow-md border border-gray-100 hover:shadow-lg hover:border-lime/50 transition-all group">
              <div className="flex items-center gap-3 mb-2 sm:block">
                <div className="w-12 h-12 bg-lime/20 text-lime rounded-lg flex items-center justify-center flex-shrink-0 sm:mb-4">
                  <svg className="w-6 h-6" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <h3 className="font-heading font-bold text-lg text-navy sm:mb-2 group-hover:text-lime transition-colors">Pet Care</h3>
              </div>
              <p className="text-slate text-sm leading-relaxed">
