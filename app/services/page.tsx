          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-md border border-gray-100 flex flex-col">
              <div className="flex items-center gap-3 mb-2 md:block">
                <div className="w-12 h-12 md:w-14 md:h-14 bg-lime/20 text-lime rounded-xl flex items-center justify-center flex-shrink-0 md:mb-4">
        ...
        <div className="container-custom max-w-4xl">
          <div className="text-center mb-8">
            <h2 className="font-heading font-bold text-3xl md:text-4xl text-navy mb-4">
              Work in a specific sector<span className="text-lime">?</span>
            </h2>
            <p className="text-lg text-slate">
              We have dedicated pages with tailored info for your industry.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
            <Link href="/trades-websites" className="flex items-center gap-4 bg-lightgrey rounded-xl p-5 hover:shadow-md hover:bg-white transition-all group">
              ...
              <div>
                <h3 className="font-heading font-bold text-lg text-navy group-hover:text-lime transition-colors">Trades websites</h3>
                <p className="text-slate text-sm">Plumbers, electricians, builders & more</p>
              </div>
            </Link>
            <Link href="/pet-care-websites" className="flex items-center gap-4 bg-lightgrey rounded-xl p-5 hover:shadow-md hover:bg-white transition-all group">
              <div className="w-12 h-12 bg-lime/20 text-lime rounded-lg flex items-center justify-center flex-shrink-0">
                <svg className="w-6 h-6" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div>
                <h3 className="font-heading font-bold text-lg text-navy group-hover:text-lime transition-colors">Pet care websites</h3>
                <p className="text-slate text-sm">Dog walkers, groomers, pet sitters & more</p>
              </div>
            </Link>
          </div>
        </div>
